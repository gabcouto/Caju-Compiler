...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    TK_PR_BOOL = 270,              /* TK_PR_BOOL  */
    TK_OC_LE = 271,                /* TK_OC_LE  */
    TK_OC_GE = 272,                /* TK_OC_GE  */
    TK_OC_EQ = 273,                /* TK_OC_EQ  */
    TK_OC_NE = 274,                /* TK_OC_NE  */
    TK_OC_AND = 275,               /* TK_OC_AND  */
    TK_OC_OR = 276,                /* TK_OC_OR  */
    TK_LIT_FALSE = 277,            /* TK_LIT_FALSE  */
    TK_LIT_TRUE = 278,             /* TK_LIT_TRUE  */
    TK_LIT_INT = 279,              /* TK_LIT_INT  */
    TK_LIT_FLOAT = 280,            /* TK_LIT_FLOAT  */
    TK_LIT_CHAR = 281,             /* TK_LIT_CHAR  */
    TK_ERRO = 282                  /* TK_ERRO  */
  };
